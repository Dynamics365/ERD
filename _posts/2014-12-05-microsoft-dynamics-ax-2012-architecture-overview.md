...
![]({{site.url}}/assets/imagesposts/imagesposts/AXSystemArchitechture.gif)
...
![]({{site.url}}/assets/imagesposts/imagesposts/AOSWindowsService.gif)
...
![]({{site.url}}/assets/imagesposts/imagesposts/Business_Connector_Client.gif)


### 3. Application file server architecture

![]({{site.url}}/assets/imagesposts/imagesposts/App_file_server_architechture.gif)
...
![]({{site.url}}/assets/imagesposts/imagesposts/Model_store_architecture.gif)

The following table describes the application object layers in Microsoft Dynamics AX 2012:

![]({{site.url}}/assets/imagesposts/imagesposts/Layer.png)

## Client architecture

This diagram describes the functionality within the client, and describes how communications flow within it.

![]({{site.url}}/assets/imagesposts/imagesposts/Client_architecture.gif)

## Client/server communication

![]({{site.url}}/assets/imagesposts/imagesposts/ClientServer_communication.gif)
...
![]({{site.url}}/assets/imagesposts/imagesposts/WCF_architecture.png)
...
![]({{site.url}}/assets/imagesposts/imagesposts/EP_Architecture.gif)

## Security architecture

This following diagram provides a high-level overview of the security architecture of Microsoft Dynamics AX 2012.

![]({{site.url}}/assets/imagesposts/imagesposts/Security_architecture.gif)
...
![]({{site.url}}/assets/imagesposts/imagesposts/Workflow_system_arcitechture (1).gif)
...
![]({{site.url}}/assets/imagesposts/imagesposts/Analytic_architecture.gif)

## Reporting architecture

The following diagram illustrates the architecture of the reporting functionality in Microsoft Dynamics AX.

![]({{site.url}}/assets/imagesposts/imagesposts/reporting_architecture.png)
